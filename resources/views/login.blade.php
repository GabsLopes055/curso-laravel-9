...
@section('content')
    ...
    <div class="text-center" style="margin-top: 10%;">
        <svg style="height: 250px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <g opacity="0.5">
                <circle cx="349" cy="349" r="349"
                    fill="url(#b247946c-c62f-4d08-994a-4c3d64e1e98f-441)" />
            </g>
            ...
            <path
                ...
                transform="translate(-251 -101)" fill="#232323" />
            ...
            <path d="M489.49,335.68S553.32,465.24,733.37,390l-41.92-65.73-74.31-26.67Z" transform="translate(-251 -101)"
                opacity="0.1" />
            <path d="M489.49,333.78s63.83,129.56,243.88,54.3l-41.92-65.73-74.31-26.67Z" transform="translate(-251 -101)"
                fill="#333" />
            <path
            ...
            <div class="mt-5">
                <div class="mt-3">
                    ...
                    <div class="d-flex justify-content-center">
                        <input class="form-control w-25 text-center" type="email" name="email" id="email"
        ...
        <button class="btn btn-outline-dark w-25 mb-4">Cadastrar-se</button>
    </div>
